...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <div class="sidebar">
                    ...
                    @if (Session::has('user'))
                        ...
                        @else
                            <div class="image">
                                ...
                                <img src="/images/iconUser.png" class="img-circle elevation-2" alt="User Image">
                            </div>
                        @endif
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    ...
                                    class="nav-link {{ str_contains($url, route('danh-muc-san-pham.index')) ? 'btn-danger' : '' }}">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('quan-ly-san-pham') }}"
                                        class="nav-link {{ str_contains($url, route('admin-products')) ? 'btn-danger' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item menu-item has-treeview">
                            <a href="{{ url('quan-ly-loai-san-pham') }}"
                                class="nav-link {{ str_contains($url, route('admin-categories')) ? 'btn-danger' : '' }}">
                        ...
                        <li class="nav-item menu-item has-treeview">
                            <a href="{{ url('/quan-ly-don-hang') }}"
                                class="nav-link {{ str_contains($url, route('admin-orders')) ? 'btn-danger' : '' }}">
                        ...
                        <li class="nav-item menu-item has-treeview">
                            <a href="{{ url('/quan-ly-nguoi-dung') }}"
                                class="nav-link {{ str_contains($url, route('admin-customers')) ? 'btn-danger' : '' }}">
                        ...
                        <li class="nav-item menu-item has-treeview">
                            <a href="{{ route('quan-ly-slide') }}"
                                class="nav-link {{ str_contains($url, route('quan-ly-slide')) ? 'btn-danger' : '' }}">
        ...
        <footer class="main-footer">
            <strong><a href="https://www.facebook.com/Hunre.fanpage" target="_blank"
                    style="margin : 0 0 0 8px;">TVStore
                </a>.</strong>
            All rights reserved.
